...
// Mutate calls f(ctx, m).
func (f ClaudeMetadataFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
...
// function as ClaudeSession mutator.
type ClaudeSessionFunc func(context.Context, *ent.ClaudeSessionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ClaudeSessionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
