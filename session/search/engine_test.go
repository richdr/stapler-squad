...
func TestSearchEngine_Search_Ranking(t *testing.T) {
	...
	_ = engine.IndexMessage("session-1", 0, "user", "docker", time.Now())                    // 1 occurrence
	_ = engine.IndexMessage("session-1", 1, "assistant", "docker docker docker", time.Now()) // 3 occurrences
